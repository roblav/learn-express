...
test(function _initMultipart() {
  ...
  gently.expect(MultipartParserStub, 'create', function() {
    PARSER = this;
  });
  ...
  (function testRegularField() {
    var PART;
    gently.expect(EventEmitterStub, 'create', function() {
      PART = this;
    });
...
test(function _initUrlencoded() {
  ...
  gently.expect(QuerystringParserStub, 'create', function() {
    PARSER = this;
  });
...
test(function handlePart() {
  ...
  (function testFilePart() {
    ...
    gently.expect(FileStub, 'create', function(properties) {
